...
a_cpu = np.random.randn(MATRIX_SIZE, MATRIX_SIZE2).astype(np.float32)
b_cpu = np.random.randn(MATRIX_SIZE, MATRIX_SIZE2).astype(np.float32)
...
c_gpu = gpuarray.empty((MATRIX_SIZE, MATRIX_SIZE2), np.float32)
...
matrixmul(
    ...
    grid = (MATRIX_SIZE / TILE_SIZE, MATRIX_SIZE2 / TILE_SIZE),
